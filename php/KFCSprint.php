...
<!-- Masthead-->
<header id="welcome" class="masthead" style="background-image: url('../assets/img/KFC_Sprint_DARK.jpg')">
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
        <div class="d-flex justify-content-center">
            <div class="text-center">
                <h1 class="mx-auto my-0 text-uppercase">KFC Sprint</h1>
            </div>
        </div>
    </div>
</header>
...
<footer class="footer bg-black small text-center text-white-50">
    ...
    <div class="container px-4 px-lg-5">This entire thing is an elaborate inside joke. Kaval can't give directions.</div>
</footer>
<!-- Bootstrap core JS-->
