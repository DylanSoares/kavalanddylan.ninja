<?php
function JoinGenerateTable($email): string
{
    ...
    while ($row = $result->fetch_assoc()) {
        $output = $output . "<tr><td>" . $row["d.fname"] . "</td><td>" . $row["t.KFC_Sprint"] . "</td><td>" . $row["t.Costco_Cup"] . "</td><td>" . $row["t.Orchard_Park_Run"] . "</td><td>";
        $output = $output . "</td></tr>";
    }
