    ...
    <div class="container px-4 px-lg-5">
        ...
        <a class="course" href="KFCSprint.php">
            <div class="row gx-0 justify-content-center">
                <div class="col-lg-6 orange-border"><img class="img-fluid" src="../assets/img/KFC_Sprint_DARK_COLOR.jpg" alt="..."/></div>
        ...
        <a class="course" href="OrchardParkRun.php">
            <div class="row gx-0 pb-5 mt-4 justify-content-center">
                <div class="col-lg-6 orange-border"><img class="img-fluid" src="../assets/img/Orchard_Park_Run_DARK_COLOR.jpg" alt="..."/></div>
                <div class="col-lg-6 order-lg-first">
                    <div class="bg-mid text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-right">
